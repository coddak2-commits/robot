import { getWeldingConfig, WeldingConfigData } from '../../../../lib';
...
export const defaultSequenceSettings: WeldingSequenceSettings = {
  ...
  p12TouchTop: true,
  p12TouchBottom: true,
  splineMoveEnabled: false,
  splineType: 1,
  splineAverageTime: 2000,
...
export const mapConfigToSequenceSettings = (config: WeldingConfigData): WeldingSequenceSettings => ({
  ...
  touchHomeRetractOffset: config.touch_sensing_home_retract_offset ?? 100,
  ...
  splineMoveEnabled: config.spline_move_enabled ?? false,
  splineType: config.spline_type ?? 1,
  splineAverageTime: config.spline_average_time ?? 2000,
